        ...
        <div className="mt-8">
            ...
            <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
                <aside className="items-center grid-flow-col">
                    ...
                    <p>HavenCrest. <br />Providing reliable properties since 2017</p>
                </aside>
                <aside className="items-center grid-flow-col mt-12 hidden md:flex">
            ...
            <footer className="sm:hidden footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
